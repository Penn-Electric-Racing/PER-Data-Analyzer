...
class analyzer:
    ...
    def plot(
        ...
        self.__dataplotter.plot_norm(variables, label, label_list, h_lines, v_lines)
    ...
    def plot_join(
        ...
        self.__dataplotter.set_plot(start_time, end_time, same_graph, time_unit)
        self.__dataplotter.plot_dual_group(
            left_variables,
            right_variables,
    ...
    def get_compute_arrays(
        ...
        """
        return self.__operator.get_compute_arrays(
            op_list, match_type, start_time, end_time, time_unit
        )
    ...
    def get_band_filter(
        ...
        """
        return self.__operator.get_band_filter(
            band_list,
            sample_frequency,
            filtered_lower_band,
            filtered_upper_band,
    ...
    def get_integral(self, arr, start_time=0, end_time=-1, time_unit="s"):
        ...
        """
        filtered_arr = self.__operator.get_filtered_nparr(
            arr, start_time, end_time, time_unit
        )
    ...
    def analyze_data(self, arr_list: list, start_time=0, end_time=-1, time_unit="s"):
        ...
        for arr in arr_list:
            ...
            max_value, max_timestamp, min_value, min_timestamp = (
                self.__operator.get_max_min(filtered_arr)
            )
            decimals = 0
            ...
            print(
                f"Start: {display_start_time}{time_unit} | End: {display_end_time}{time_unit} | Duration: {duration}{time_unit}"
            )
